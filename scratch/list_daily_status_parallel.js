...
client.once('ready', async () => {
  ...
  console.log(`Mengambil username Discord untuk ${rows.length} user secara paralel...\n`);
  ...
  resolvedRows.forEach((row, idx) => {
    ...
    console.log(`${String(idx + 1).padEnd(5)}| ${row.user_id.padEnd(19)}| ${row.username.padEnd(26)}| ${String(row.balance).padEnd(12)}| ${klaim}`);
  });

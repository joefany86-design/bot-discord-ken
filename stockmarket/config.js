...
module.exports = {
  ...
  LEADERBOARD_RICH_CHANNEL_ID: process.env.LEADERBOARD_RICH_CHANNEL_ID || '1510232295448117308',
  LEADERBOARD_PET_CHANNEL_ID: process.env.LEADERBOARD_PET_CHANNEL_ID || '1510232295448117308',
  LEADERBOARD_DAILY_CHANNEL_ID: process.env.LEADERBOARD_DAILY_CHANNEL_ID || '1510232295448117308',
  ...
  robbery: {
    ...
    JAIL_SOLO_SECONDS: 600,       // Masa hukuman Solo Rob: 10 menit (600s)
    JAIL_HEIST_BASE: 3600,        // Masa hukuman Heist: 1 jam (3600s)
    BAIL_SOLO: 400,               // Uang jaminan Solo Rob: Rp 400
    BAIL_HEIST: 4500,             // Uang jaminan Heist: Rp 4.500
    PREP_FEE: 650,                // Biaya persiapan Heist per orang

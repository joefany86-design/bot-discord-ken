          ...
          try {
            if (iPet.customId === 'pet_btn_refresh') {
              ...
              try {
                ...
                if (!freshPet) {
                  return iPet.reply({ content: '❌ Anda tidak memiliki pet aktif!', ephemeral: true });
                }
                ...
                await iPet.reply({ embeds: [embeds.errorEmbed('Gagal Membuka Menu Booster!', err.message)], ephemeral: true });
              }
